...
export const AvatarIcon: FC<IIconProps> = ({ fill }: IIconProps) => {

    return <div>
        <svg xmlns="http://www.w3.org/2000/svg" fill={fill} id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" /* width="36" height="36" */>
