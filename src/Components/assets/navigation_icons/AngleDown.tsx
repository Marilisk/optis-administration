...
export const AngleDown: FC<IIconProps> = ({ fill }: IIconProps) => {

    return <div >
        <svg xmlns="http://www.w3.org/2000/svg" fill={fill} id="Layer_1" viewBox="0 0 24 24" data-name="Layer 1" width="40" height="40">
